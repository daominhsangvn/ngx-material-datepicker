...
export type ClockView = 'hour' | 'minute' | 'ampm';
...
@Component({
  ...
  template: `
<div class="ngx-clock">
  <div class="ngx-clock-center"></div>
  <div class="ngx-clock-hand" [ngStyle]="_hand"></div>
  <div class="ngx-clock-hours" [class.active]="_hourView">
    <div *ngFor="let item of _hours"
         class="ngx-clock-cell"
         [class.ngx-clock-cell-selected]="_selectedHour == item.value"
         [class.ngx-clock-cell-disabled]="!item.enabled"
         [style.top]="item.top+'%'"
         [style.left]="item.left+'%'"
         [style.fontSize]="item.fontSize">{{ item.displayValue }}</div>
  </div>
  <div class="ngx-clock-minutes" [class.active]="!_hourView">
    <div *ngFor="let item of _minutes"
         class="ngx-clock-cell"
         [class.ngx-clock-cell-selected]="_selectedMinute == item.value"
         [class.ngx-clock-cell-disabled]="!item.enabled"
         [style.top]="item.top+'%'"
...
export class NgxMaterialClock implements AfterContentInit {
  /**
