  ...
  template: `
    <div class="ngx-datepicker-container">
      <div class="header ng-material-datepicker">
        ...
        <div class="mat-datepicker-header-time"
             *ngIf="data.type === 'time' || data.type === 'datetime'"
             [class.active]="_mainView === 'clock'">
          <a href="javascript:void(0)" class="mat-datepicker-header-hour"
             [class.active]="_clockView === 'hour' && !ampmView"
             (click)="_toggleHours('hour')">{{ hours }}</a>:<a href="javascript:void(0)"
                                                               class="mat-datepicker-header-minute"
                                                               [class.active]="_clockView === 'minute' && !ampmView"
                                                               (click)="_toggleHours('minute')">{{ minutes }}</a>
          <a href="javascript:void(0)"
             *ngIf="disable24Hr"
             class="mat-datepicker-header-ampm"
             [class.active]="ampmView"
             (click)="_toggleAmpm()">{{ ampm }}</a>
        </div>
      </div>
      <div class="ngx-datepicker-content">
        <div class="ngx-datepicker-inner">
          <div class="ngx-datepicker-calendar" [class.active]="_mainView === 'calendar'">
            <div class="nav ng-material-datepicker">
              <button mat-icon-button class="left" [class.disabled]="!_previousEnabled()" (click)="onPrevMonth()">
                <mat-icon>keyboard_arrow_left</mat-icon>
              </button>
              <div class="title">
                <div [@calendarAnimation]="animate">{{ displayMonth.full }} {{ displayYear }}</div>
              </div>
              <button mat-icon-button class="right" [class.disabled]="!_nextEnabled()" (click)="onNextMonth()">
          ...
          <div class="ngx-datepicker-clock" [class.active]="_mainView === 'clock'">
            <ngx-clock [startView]="_clockView"
                          ...
                          (selectedChange)="_onTimeChange($event)"></ngx-clock>
          </div>

          <div class="ngx-datepicker-calendar" [class.active]="_mainView === 'year'">
            <div class="nav ng-material-datepicker">
              <button mat-icon-button class="left" [class.disabled]="!_previousEnabled()" (click)="onPrevYear()">
                <mat-icon>keyboard_arrow_left</mat-icon>
              </button>
              <div class="title">
                <div [@calendarAnimation]="animate">{{ displayYear }}</div>
              </div>
              <button mat-icon-button class="right" [class.disabled]="!_nextEnabled()" (click)="onNextYear()">
                <mat-icon>keyboard_arrow_right</mat-icon>
              </button>
            </div>
            <div class="content ng-material-datepicker">
        ...
        <div class="footer ng-material-datepicker">
          <a mat-button (click)="onToday()" *ngIf="_canActiveDate(today)">Today</a>
          <!--<a mat-button (click)="onCancel()">Cancel</a>-->
          <a mat-button (click)="onOk()">Ok</a>
          <a mat-button (click)="onClear()">Clear</a>
        </div>
      </div>
    </div>
  `,
